...
<script>
	...
	// Misc
	import {approvalRequest} from '$lib/js/wallet_approval';
	import { config, stampLimits } from '$lib/js/config.js';
	import { walletInfo, showModal, userAccount, stampRatio, currency, tabHidden, tauPrice} from '$lib/js/stores.js';
	import {stringToFixed, toBigNumber} from '$lib/js/utils.js';
	import {processTxResults, createSnack, refreshTAUBalance, checkForApproval} from '$lib/js/store-utils.js';
	import { TransactionResultHandler } from '$lib/js/transaction_result_handler'
	import * as socketservice from '$lib/js/socketservice'
